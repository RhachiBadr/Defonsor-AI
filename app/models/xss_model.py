...
class XSSModel:
    def __init__(self, tokenizer_path='models/xss_tokenizer.json', model_path='models/xss_model.h5'):
        try:
            ...
            if not os.path.exists(full_model_path):
                raise FileNotFoundError(f"XSS model file not found at {full_model_path}")
